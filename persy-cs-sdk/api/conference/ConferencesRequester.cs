...
{
    /// <summary>
    /// This class represents the set of wrappers around the Persephony Conference API.
    ...
    public sealed class ConferencesRequester : APIRequester
    {
        ...
        /// <summary>
        /// Create a new conference through the Persephony API using a registered
        ...
        public Conference create(ConferenceCreateOptions conferenceOptions = null)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                ...
                throw new PersyException(String.Format("Failed to create conference with options {0}", ((conferenceOptions != null) ? conferenceOptions.toJson() : string.Empty)));
            }
        ...
        /// <summary>
        /// Retrieve a list of conferences from Persephony.
        /// </summary>
        ...
        /// of conference instances as returned by the Persephony API. 
        /// </returns>
        /// <exception cref="PersyException">Thrown upon failed request.</exception>
        ...
        public ConferenceList getConferences(ConferenceSearchFilters filters = null)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException("Failed to get conference list");
            }
        ...
        /// <returns>A Conference object returned by Persephony that represents the queue that was retrieved.</returns>
        /// <exception cref="PersyException">Thrown upon failed request.</exception>
        public Conference getConference(string conferenceId)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException(String.Format("Failed to get conference {0} information", conferenceId ?? ""));
            }
        ...
        public Conference update(string conferenceId, ConferenceOptions conferenceOptions = null)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException(String.Format("Failed to update conference {0} information", conferenceId ?? ""));
            }
        ...
        public Participant update(string conferenceId, string callId, ParticipantOptions participantOptions = null)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException(String.Format("Failed to update conference {0} participant {1} information", conferenceId ?? "", callId ?? ""));
            }
        ...
        /// <returns>
        /// An in-language representation of Persephony's paginated list response. This will be a paginated list 
        /// of recording instances as returned by the Persephony API. 
        /// </returns>
        /// <exception cref="PersyException">Thrown upon failed request.</exception>
        public RecordingList getRecordings(string conferenceId)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException(String.Format("Failed to get recording list information for conference {0}", conferenceId ?? ""));
            }
        ...
        /// <returns>
        /// An in-language representation of Persephony's paginated list response. This will be a paginated list 
        /// of participant instances as returned by the Persephony API. 
        /// </returns>
        /// <exception cref="PersyException">Thrown upon failed request.</exception>
        public ParticipantList getParticipants(string conferenceId, bool talk, bool listen)
        {
            ...
            if (string.IsNullOrEmpty(json) == true)
            {
                throw new PersyException(String.Format("Failed to get participant list information for conference {0}", conferenceId ?? ""));
            }
        ...
        /// <summary>
        /// Delete a Persephony participant from a conference.
        /// </summary>
        /// <param name="conferenceId">The conferenceId of the target conference.</param>
        ...
        /// <summary>
        /// Delete a Persephony conference.
        /// </summary>
        /// <param name="conferenceId">The conferenceId of the target conference.</param>
        /// <exception cref="PersyException">Thrown upon failed request.</exception>
