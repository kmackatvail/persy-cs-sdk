    ...
    public class ApplicationRequesterTest
    {
        ...
        public void UpdateApplicationTest()
        {
            try
            {
                ...
                options.setVoiceUrl("http://CreateAccountTest:3000/VoiceUrl2");
                options.setVoiceFallbackUrl("http://CreateAccountTest:3000/VoiceUrl2");
                options.setCallConnectUrl("http://CreateAccountTest:3000/CCUrl2");
                options.setStatusCallbackUrl("http://CreateAccountTest:3000/Status2");
                Application app = requester.update("APe4238465edbc017acfbddfe80c66594ef6c72669", options);

                Assert.IsNotNull(app);
                Assert.AreEqual(app.getAlias, "new test application 1");
                Assert.AreEqual(app.getVoiceFallbackUrl, "http://CreateAccountTest:3000/VoiceUrl2");
                Assert.AreEqual(app.getVoiceUrl, "http://CreateAccountTest:3000/VoiceUrl2");
                Assert.AreEqual(app.getStatusCallbackUrl, "http://CreateAccountTest:3000/Status2");
                Assert.AreEqual(app.getCallConnectUrl, "http://CreateAccountTest:3000/CCUrl2");
                Assert.AreEqual(app.getApplicationId, "APe4238465edbc017acfbddfe80c66594ef6c72669");
            }
            catch (PersyException pe)
            {
        ...
        public void CreateApplicationTest()
        {
            try
            {
                ...
                options.setVoiceUrl("http://CreateAccountTest:3000/VoiceUrl");
                options.setVoiceFallbackUrl("http://CreateAccountTest:3000/VoiceUrl");
                options.setCallConnectUrl("http://CreateAccountTest:3000/CCUrl");
                options.setStatusCallbackUrl("http://CreateAccountTest:3000/Status");
                Application app = requester.create(options);

                Assert.IsNotNull(app);
                Assert.AreEqual(app.getAlias, "test application 1");
                Assert.AreEqual(app.getVoiceFallbackUrl, "http://CreateAccountTest:3000/VoiceUrl");
                Assert.AreEqual(app.getVoiceUrl, "http://CreateAccountTest:3000/VoiceUrl");
                Assert.AreEqual(app.getStatusCallbackUrl, "http://CreateAccountTest:3000/Status");
                Assert.AreEqual(app.getCallConnectUrl, "http://CreateAccountTest:3000/CCUrl");
