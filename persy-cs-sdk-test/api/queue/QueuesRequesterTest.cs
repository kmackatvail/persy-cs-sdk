...
namespace persy_cs_sdk_test.api.queue
{
    [TestClass]
        ...
        public void QueueMemberListTest()
        {
            ...
            { 
                ...
                MethodInfo persyUrlMethodInfo = callsRequesterType.GetMethod("setPersyUrl",
                                                                             ...
                                                                             null);
                persyUrlMethodInfo.Invoke(queuesRequester, new Object[] { "http://QueueMemberList:3000" });
        ...
        public void QueueListTest()
        {
            try
            {
                ...
                MethodInfo persyUrlMethodInfo = callsRequesterType.GetMethod("setPersyUrl",
                                                                             ...
                                                                             new Type[] { typeof(System.String) },
                                                                             null);
                persyUrlMethodInfo.Invoke(queuesRequester, new Object[] { "http://QueueList:3000" });
